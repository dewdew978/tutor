...
import { ChapterItem, LessonItem, CourseItem } from "@/lib/types";
...
export default function EditCoursePage({ params }: PageProps) {
  ...
  const [status, setStatus] = useState<"PUBLISHED" | "CLOSED" | "ARCHIVED" | "DRAFT">("PUBLISHED");
  const [coverImage, setCoverImage] = useState("");
  const [trailerUrl, setTrailerUrl] = useState("https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4");
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#EAECF0] px-4 sm:px-8 py-3.5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 text-[11px] font-semibold text-[#667085]">
              ...
              <span>/</span>
              <span className="text-[#7F56D9] font-bold">แก้ไขคอร์สเรียน (Editor)</span>
            </div>
            <h1 className="text-base sm:text-lg font-extrabold text-[#101828] tracking-tight line-clamp-1 max-w-xl">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            target="_blank"
            className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-[#D0D5DD] bg-white px-3.5 py-2 text-xs font-bold text-[#344054] shadow-unt-xs hover:bg-[#F9FAFB]"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          {[
            ...
            { step: 4, title: "4. ตรวจสอบ & บันทึก", desc: "Live Preview หน้าร้าน" },
          ].map((item) => (
            <button
              key={item.step}
        ...
        {currentStep === 1 && (
          <div className="space-y-6 animate-in fade-in-50 duration-200">
            <div className="rounded-3xl border border-[#EAECF0] bg-white p-6 sm:p-8 shadow-unt-xs space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-[#101828]">แก้ไขข้อมูลหลักของคอร์สเรียน</h3>
                <p className="text-xs text-[#667085]">ปรับปรุงชื่อคอร์ส คำโปรย และราคาให้เป็นปัจจุบัน</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="block text-xs font-bold text-[#344054]">
                    สถานะการเปิดรับสมัคร (Course Status) <span className="text-[#F04438]">*</span>
                  </label>
                  <select
                    value={status}
                    onChange={(e) => setStatus(e.target.value as any)}
                    className="w-full rounded-xl border border-[#D0D5DD] bg-white px-4 py-2.5 text-xs font-bold text-[#101828] shadow-unt-xs focus:border-[#7F56D9] focus:outline-none"
                  >
                    <option value="PUBLISHED">🟢 เปิดรับสมัคร (PUBLISHED - แสดงในหน้าร้านและเปิดรับนักเรียนใหม่)</option>
                    <option value="CLOSED">🔴 ปิดรับสมัคร / ปิดคอร์ส (CLOSED - ซ่อนจากหน้าร้าน & หยุดรับนักเรียนใหม่)</option>
                    <option value="DRAFT">🟡 ฉบับร่าง (DRAFT - เตรียมเนื้อหา ยังไม่เผยแพร่)</option>
                    <option value="ARCHIVED">⚪ เก็บเข้าคลังถาวร (ARCHIVED - ยุติการเปิดสอน)</option>
                  </select>
                  <p className="text-[11px] text-[#667085]">
                    💡 หากเลือก &quot;ปิดรับสมัคร/ปิดคอร์ส&quot; นักเรียนใหม่จะไม่สามารถกดสมัครได้ แต่นักเรียนเดิมที่เคยซื้อคอร์สแล้วจะยังคงเข้าเรียนบทเรียนเดิมได้ตามปกติ
                  </p>
                </div>
          ...
          <div className="space-y-6 animate-in fade-in-50 duration-200">
            ...
            <div className="flex justify-between items-center pt-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#7F56D9] px-6 py-2.5 text-xs font-bold text-white shadow-unt-xs hover:bg-[#6941C6] transition-all cursor-pointer"
              >
                <span>ถัดไป: ดูตัวอย่างสด & บันทึก</span>
                <ChevronRight className="h-4 w-4" />
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-in fade-in-50 duration-200">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
                ...
                <div className="rounded-2xl border border-[#EAECF0] bg-[#F9FAFB] p-6 shadow-unt-xs space-y-4 h-fit">
                  ...
                  >
                    ...
                    <span>บันทึกการแก้ไขคอร์สนี้</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-3">
              ...
              <button
                onClick={handleSaveCourse}
                disabled={isSaving || saveSuccess}
                className="inline-flex items-center gap-2 rounded-xl bg-[#7F56D9] px-8 py-3 text-xs font-bold text-white shadow-unt-sm hover:bg-[#6941C6] transition-all cursor-pointer"
              >
                <Save className="h-4 w-4" />
