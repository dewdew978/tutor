        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl border border-[#EAECF0] bg-white p-6 sm:p-10 shadow-unt-xs space-y-8 text-xs sm:text-sm text-[#475467] leading-relaxed">
            ...
            <div className="space-y-3">
              <p>
                ยินดีต้อนรับสู่ <strong>P&apos;Toh Tutor</strong> ขอความกรุณาอ่านข้อกำหนดและเงื่อนไขการใช้บริการฉบับนี้อย่างละเอียด การที่ท่านสมัครสมาชิก ลงทะเบียนเข้าเรียน หรือเข้าใช้งานส่วนใดส่วนหนึ่งของเว็บไซต์ ถือว่าท่านได้ยอมรับและตกลงที่จะปฏิบัติตามข้อกำหนดเหล่านี้อย่างครบถ้วน
              </p>
            </div>
            ...
            <div className="space-y-3 border-t border-[#EAECF0] pt-6">
              ...
              <p>
                สื่อการสอนทั้งหมด ซึ่งรวมถึงวิดีโอบทเรียน เอกสารประกอบการเรียน ชีทสรุปสูตร PDF แบบฝึกหัด และระบบข้อสอบ ถือเป็นลิขสิทธิ์และทรัพย์สินทางปัญญาของ <strong>พี่โต๋</strong> และ <strong>P&apos;Toh Tutor</strong> แต่เพียงผู้เดียว
              </p>
