...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white text-[#101828]">
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-10 lg:p-14 max-w-xl lg:max-w-2xl mx-auto w-full">
        ...
        <div>
          ...
          <div className="space-y-2.5 mb-8">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-[#F4EBFF] px-3.5 py-1 text-xs sm:text-sm font-semibold text-[#7F56D9] border border-[#E9D7FE]">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-[#667085]" />
                <input
                  type="text"
                  required
                  autoComplete="name"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-[#667085]" />
                  <input
                    type="tel"
                    autoComplete="tel"
            ...
            <div className="pt-2">
              <label className="flex items-start gap-2.5 cursor-pointer select-none text-xs sm:text-sm text-[#475467]">
                <input
                  type="checkbox"
                  required
                  checked={acceptTerms}
                  onChange={(e) => setAcceptTerms(e.target.checked)}
                  className="mt-0.5 h-4.5 w-4.5 rounded border-[#D0D5DD] text-[#7F56D9] focus:ring-[#7F56D9] accent-[#7F56D9]"
                />
                <span>
                  ฉันยอมรับ{" "}
      ...
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-[#53389E] via-[#6941C6] to-[#7F56D9] p-12 xl:p-16 text-white flex-col justify-between overflow-hidden">
        {/* Ambient Glow */}
        <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-white/10 blur-3xl" />

        {/* Top Tag */}
        <div className="relative z-10 flex items-center justify-between">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/20 px-3.5 py-1.5 text-xs sm:text-sm font-semibold text-white border border-white/30 backdrop-blur-xs">
            <GraduationCap className="h-4 w-4" />
            สิทธิประโยชน์ของนักเรียน P&apos;Toh
          </span>
          <span className="text-xs sm:text-sm text-[#E9D7FE] font-medium">Lifetime Access</span>
        </div>
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          ...
          <div className="space-y-4 pt-1">
            <div className="rounded-2xl bg-white/10 border border-white/15 p-4.5 backdrop-blur-xs flex items-start gap-3.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#12B76A] text-white shrink-0">
                <Check className="h-5 w-5" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-white">ทดลองเรียนบทเรียนฟรี (Free Preview)</h4>
                <p className="text-xs text-[#E9D7FE] mt-1">เปิดดูคลิปปูพื้นฐานและข้อสอบจริงได้ทันทีโดยไม่ต้องเสียค่าใช้จ่าย</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white/10 border border-white/15 p-4.5 backdrop-blur-xs flex items-start gap-3.5">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">ดาวน์โหลดชีทสรุปสูตร PDF 4 สี</h4>
                <p className="text-xs text-[#E9D7FE] mt-1">เอกสารประกอบการเรียนพร้อมแบบฝึกหัดเฉลยละเอียดครบทุกบท</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white/10 border border-white/15 p-4.5 backdrop-blur-xs flex items-start gap-3.5">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">ถาม-ตอบ Q&A กับพี่โต๋โดยตรง</h4>
                <p className="text-xs text-[#E9D7FE] mt-1">สงสัยโจทย์ข้อไหนพิมพ์ถามใต้คลิป พี่โต๋เข้ามาตอบให้อย่างละเอียด 100%</p>
              </div>
            </div>
          </div>
        </div>
